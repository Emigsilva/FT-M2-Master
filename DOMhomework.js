...
function buildToDo(todo, index) {
  ...
  //al innerhtml del span que acabo de crear
  //seteale el valor de descripcion
  //paso 5
  ...
  // pasándole esta función como callback
...
function buildToDos(toDos) {
  // Tu código acá:
  //[{description: "hola", complete: false}]
